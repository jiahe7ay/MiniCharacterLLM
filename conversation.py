...
class Conversation:
    ...
    def __init__(self, name: str, system: str, roles: List[str], messages: List[List[str]], offset: int, sep_style: SeparatorStyle, sep: str, sep2: str = None, start: str = None, stop_str: str = None, stop_token_ids: List[int] = None):
        self.name = name
        self.system = system
        self.roles = roles
...
def get_conv_template(name: str) -> Conversation:
    ...
    #print(conv_templates['qwen'].copy())
...
if __name__ == "__main__":
    ...
    conv.append_message(conv.roles[1], "ssss")
